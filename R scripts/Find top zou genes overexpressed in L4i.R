...
ff <- read.csv('/Users/willli/Documents/Zambidis lab/L4i RNAseq/clusterekmeanZGA_Riboseq_withoocyte_Vover0_k6.csv')
### https://humantfs.ccbr.utoronto.ca/download.php 
tf <- read.delim('/Users/willli/Documents/Zambidis lab/L4i RNAseq/TF_names_v_1.01.txt')
...
write.csv(top_by_cluster, file = "/Users/willli/Documents/Zambidis lab/L4i RNAseq/L4i_Zou_top_by_cluster.csv")
